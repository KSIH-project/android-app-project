...
public class User implements Serializable {
    ...
    public User(String user_firstName, String user_lastName, String user_email, String user_mobile,
                String user_profession, String user_linkedInUrl, String user_githubUrl, String user_mediumUrl,
                String user_facebookUrl, String user_twitterUrl, String user_image) {
